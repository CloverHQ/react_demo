...
from [`src/index.js`](src-base/index.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `registerServiceWorker()` in
[`src/index.js`](src-base/index.js) first by modifying the service worker import:
```javascript
...
in all web browsers. Service worker registration [won't be attempted](src-base/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src-base/registerServiceWorker.js), which
